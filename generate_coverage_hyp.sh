#/bin/sh
# extract hypothetical genome coverage information using bedtools from Prokka output
...
cat data/circos/coverage/${1##*/}_cov.txt >> data/circos/coverage/cov_hyp.txt
